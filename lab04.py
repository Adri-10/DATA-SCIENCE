# -*- coding: utf-8 -*-
"""
Created on Sat Jul 31 22:19:29 2021
...
df_hist.hist(column = ['Time'], bins = 10, color='k')

#%%
#Name: Adri Saha
#ID: 2019-1-60-024
df_hist = dataframe[['Amount']]
df_hist.hist(column = ['Amount'], bins = 5, color='y')
...
#manually
'''print(dataframe["Time"].corr(dataframe['V1']))
#print(dataframe["V2"].corr(dataframe['Class']))
#print(dataframe["V4"].corr(dataframe['Amount']))
print(dataframe["V4"].corr(dataframe['Class']))
print(dataframe["V5"].corr(dataframe['Time']))
print(dataframe["V6"].corr(dataframe['Amount']))
#print(dataframe["V7"].corr(dataframe['Time']))
print(dataframe["V7"].corr(dataframe['Amount']))
#print(dataframe["V8"].corr(dataframe['Class']))
#print(dataframe["V6"].corr(dataframe['Amount']))
#print(dataframe["V10"].corr(dataframe['Time']))
print(dataframe["V12"].corr(dataframe['Time']))
print(dataframe["V5"].corr(dataframe['Time']))
#print(dataframe["V6"].corr(dataframe['Amount']))
#print(dataframe["V14"].corr(dataframe['Amount']))
#print(dataframe["V16"].corr(dataframe['Time']))
print(dataframe["V20"].corr(dataframe['Amount']))
print(dataframe["V21"].corr(dataframe['Amount']))
print(dataframe["V22"].corr(dataframe['Time']))'''
