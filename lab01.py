# -*- coding: utf-8 -*-
"""
Created on Wed Jun 30 20:16:49 2021
...
def compound_interest_2019_1_60_024(P,R,T):
    return P*(1+(R/100))**T

P = float(input("Enter principle amount: "))
R = float(input("Enter interest amount: "))
T = float(input("Enter time(years): "))
com_intreast= compound_interest_2019_1_60_024(P,R,T)
...
def prime_find_2019_1_60_024(number):
    if number>1:
...
N = int(input("Enter positive integer N : "))
if (prime_find_2019_1_60_024(N)==True):
...
def largest_number_2019_1_60_024(num):
    maxi=num[0]
...
def smallest_number_2019_1_60_024(num):
    mini= num[0]
    for i in range(len(num)):
        if num[i] < mini:
             mini = num[i] 
...
#l=len(number)
largest_number_2019_1_60_024(number)
smallest_number_2019_1_60_024(number)
...
string = 'python is mandatory in CSE303 for all CSE303 students'
print(string)
sub_string = 'CSE303'
print(sub_string)
count = 0
...
def palindrome_checker_2019_1_60_024(string):
...
check = palindrome_checker_2019_1_60_024(string)
if (check):
    print("Palindrome")
else:
